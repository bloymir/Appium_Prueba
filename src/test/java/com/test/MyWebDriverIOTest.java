...
public class MyWebDriverIOTest {
    ...
    private String mensajeFinalizado = "You made it, click retry if you want to try it again.";
    @BeforeClass
    ...
    public void testDragAndDrop() {
        ...
        String result = drioverIO.dragAnDrop();
        Assert.assertEquals(result, mensajeFinalizado);
